...
3. **결과물(논문·프로그램) 제출**
   - **논문** — [IEEE MetaCom 제출 안내](https://metacomm.org/2026/submission.php)에 따라 **IEEE 양식**으로 작성하고, **[EasyChair](https://easychair.org/conferences/?conf=metacom2026)** 에서 **"Meta-Sejong AI Robotics Challenge 2026" 트랙**을 선택해 제출합니다. 논문은 **2쪽 이상 4쪽 이하**로 작성합니다.
